...
namespace DocumentationAssistant.Config
{
	...
	[ProvideOptionPage(typeof(OptionsPage), "Documentation Assistant", "General from config", 0, 0, true)]
	[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
	public sealed class ConfigurationPackage : AsyncPackage
	{
		/// <summary>
		/// ConfigurationPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "564891f7-db7e-46b4-80be-b2dfd0ba6789";

		/// <summary>
		/// Initializes a new instance of the <see cref="ConfigurationPackage"/> class.
		/// </summary>
